...
if (hora >= 0 && hora < 12) {
    saudacao.innerHTML = "Bom dia, <strong>João Vitor</strong> 👋";
} else if (hora >= 12 && hora < 18) {
    saudacao.innerHTML = "Boa tarde, <strong>João Vitor</strong> 👋";
} else {
    saudacao.innerHTML = "Boa noite, <strong>João Vitor</strong> 👋";
}
